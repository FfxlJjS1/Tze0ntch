...
namespace Interpreator {
	namespace InterpretingStage {
		...
		public:
			InterpretingStage(vector<ModuleTable*>& moduleTables, shared_ptr<DbController> dbController, shared_ptr<AcceptedClient> acceptedClient, MethodTable* startModuleMethodTable)
